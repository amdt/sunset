...
function s:calculate(sunrisep)
	...
	let l:right_ascension = s:radians_to_degrees(atan(0.91764 * tan(s:degrees_to_radians(l:true_longitude))))
	...
	let l:cos_hour_angle = (cos(s:degrees_to_radians(s:ZENITH)) - (l:sin_declination * sin(s:degrees_to_radians(g:sunset_latitude)))) /
